               ...
               <div>
                  ...
                  <div class="login-main">
                     <form class="theme-form">
                        ...
                        <p class="mt-4 mb-0">Already have an password?<a class="ms-2" href="<?php echo e(route('customer-login')); ?>">Sign in</a></p>
                     </form>
                  </div>
               </div>
            </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.authentication.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\clari\OneDrive\School\GitHub\Potatochips\template\resources\views/Pokemon/Customer/Authentication/customer-forgot-password.blade.php ENDPATH**/ ?>