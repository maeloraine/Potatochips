          ...
          <div class="sticky-header">
            <header>                       
              <nav class="navbar navbar-b navbar-dark navbar-trans navbar-expand-xl fixed-top nav-padding" id="sidebar-menu"><a class="navbar-brand p-0" href="#"><img class="img-fluid" src="<?php echo e(asset('assets/images/landing/landing_logo.png')); ?>" alt=""></a>
                ...
                <div class="buy-btn rounded-pill" ><a class="nav-link js-scroll" style="color: white;" target="_blank" href="<?php echo e(route('customer-login')); ?>"> Log in </a></div>
              </nav>
            </header>
          </div>
          <div class="row justify-content-center"style="background-image: url('<?php echo e(asset('assets/images/jensonheader.jpg')); ?>'); background-size: cover; background-position: center;">
                ...
                <h6 class="content-title"><img class="arrow-decore" src="<?php echo e(asset('assets/images/landing/decore/arrow.svg')); ?>" alt=""><span class="sub-title">A Nature's Escape for Relaxation and Adventure </span></h6>
                  ...
                  <!-- Button container with flexbox centering -->
                    <div class="d-flex justify-content-center mt-4">
                      <a class="buy-btn rounded-pill" href="<?php echo e(route('customer-login')); ?>" target="_blank" 
              ...
              <div class="col-sm-12"> 
                <div class="testimonial-slider"> 
                  ...
                  <!-- review 1  -->
                    ...
                    <div class="customer-img"><img src="<?php echo e(asset('assets/images/user1.jpg')); ?>" alt="user1"></div>
                  </div>
                  ...
                  <div class="testimonial-box common-card"> 
                    ...
                    <div class="customer-img"><img src="<?php echo e(asset('assets/images/user2.jpg')); ?>" alt="user2"></div>
                  </div>
                  ...
                  <div class="testimonial-box common-card"> 
                    ...
                    <div class="customer-img"><img src="<?php echo e(asset('assets/images/user3.jpg')); ?>" alt="user3"></div>
                  </div>
                  ...
                  <div class="testimonial-box common-card"> 
                    ...
                    <div class="customer-img"><img src="<?php echo e(asset('assets/images/user4.jpg')); ?>" alt="user4"></div>
                  </div>
                  ...
                  <div class="testimonial-box common-card"> 
                    ...
                    <div class="customer-img"><img src="<?php echo e(asset('assets/images/user5.jpg')); ?>" alt="user5"></div>
                  </div>
                </div>
              </div>
            </div>
...
</html><?php /**PATH C:\Users\clari\OneDrive\School\GitHub\Potatochips\template\resources\views/pokemon/customer/authentication/landing-page.blade.php ENDPATH**/ ?>