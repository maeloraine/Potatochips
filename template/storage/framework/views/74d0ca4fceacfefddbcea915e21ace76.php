        ...
        <nav class="sidebar-main">
            ...
            <div id="sidebar-menu">
                <ul class="sidebar-links" id="simple-bar">
                    ...
                    <li class="sidebar-list"><a class="sidebar-link sidebar-title link-nav" href="<?php echo e(route('landing-page')); ?>">
                            <svg class="stroke-icon">
...
</div><?php /**PATH C:\Users\clari\OneDrive\School\GitHub\Potatochips\template\resources\views/admin_unique_layouts/layouts/sidebar.blade.php ENDPATH**/ ?>