      ...
      <ul class="nav-menus">
        ...
        <li class="profile-nav onhover-dropdown pe-0 py-0">
          <div class="media profile-media">
            <div class="media-body"><span><?php echo e(Auth::guard('customer')->user()->CU_FName); ?> <?php echo e(Auth::guard('customer')->user()->CU_LName); ?></span>
              <p class="mb-0 font-roboto"> Guest <i class="middle fa fa-angle-down"></i></p>
            </div>
          </div>
          <ul class="profile-dropdown onhover-show-div">
            <li>
              <a href="<?php echo e(route('account-settings')); ?>"> <!-- I-link sa account settings page -->
...
</div><?php /**PATH C:\Users\Carl\OneDrive - Polytechnic University of the Philippines\Documents\WEB DEV AUTH\Potatochips\booking_management\resources\views/pokemon/customer/home/customer-header.blade.php ENDPATH**/ ?>