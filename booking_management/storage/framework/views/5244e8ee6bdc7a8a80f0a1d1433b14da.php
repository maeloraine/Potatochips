   ...
   document.addEventListener('DOMContentLoaded', function () {
      ...
      form.addEventListener('submit', function (event) {
         ...
         if (email === 'guest@gmail.com' && password === 'guest') {
            ...
            window.location.href = "<?php echo e(route('customer-booking' , ['role' => 'customer'])); ?>";
         } else {
...
<script src="https://stackpath.bootstrapcdn.com/bootstrap/4.5.2/js/bootstrap.min.js"></script><?php /**PATH C:\Users\clari\OneDrive\School\GitHub\Potatochips\booking_management\resources\views/Pokemon/Customer/Authentication/customer-login-modal.blade.php ENDPATH**/ ?>