                ...
                <div class="card-body">
                    ...
                    <div id="cottages-list">
                        ...
                        <?php $__currentLoopData = $rooms; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $room): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="offer-card" data-id="<?php echo e($room->RoomID); ?>" data-name="<?php echo e($room->Room_Type); ?>" data-price="<?php echo e($room->Room_Rate); ?>" data-details="<?php echo e($room->Room_Description); ?>">
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <?php echo $__env->make('Pokemon.Customer.Home.customer-payment', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            </div>
            <div class="modal-footer">
