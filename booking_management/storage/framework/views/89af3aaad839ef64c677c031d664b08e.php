                ...
                <div class="card-body">
                    ...
                    <div id="cottages-list">
                        ...
                        <?php $__currentLoopData = $rooms; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $room): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="offer-card" data-id="<?php echo e($room->room_id); ?>" data-name="<?php echo e($room->Room_Type); ?>" data-price="<?php echo e($room->Room_Rate); ?>" data-details="<?php echo e($room->Room_Description); ?>">
                                <h6><?php echo e($room->Room_Type); ?></h6>
                                <p>Price: ₱<?php echo e(number_format($room->Room_Rate, 2)); ?></p>
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        document.getElementById('proceed-to-payment').addEventListener('click', function () {
            ...
            window.location.href = '<?php echo e(route("pay")); ?>';
            ...
            //     if (data.booking) {
            //         window.location.href = '<?php echo e(route("payment.index")); ?>'; // Redirect to payment page
            //     } else {
