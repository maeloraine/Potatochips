  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form class="theme-form" id="signupForm" method="POST" action="<?php echo e(route('register')); ?>"  >
          <?php echo csrf_field(); ?>
...
<script src="https://stackpath.bootstrapcdn.com/bootstrap/4.5.2/js/bootstrap.min.js"></script><?php /**PATH C:\Users\Carl\OneDrive - Polytechnic University of the Philippines\Documents\WEB DEV AUTH\Potatochips\booking_management\resources\views/Pokemon/Customer/Authentication/customer-sign-up-modal.blade.php ENDPATH**/ ?>