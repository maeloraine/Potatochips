            ...
            <div id="sidebar-menu">
                <ul class="sidebar-links" id="simple-bar">
                    ...
                    <li class="sidebar-list"><a
                            class="sidebar-link sidebar-title link-nav" href="<?php echo e(route('employee-dashboard')); ?>">
                    ...
                    <!-- Guest Management -->
                    <li class="sidebar-list"><a
                            class="sidebar-link sidebar-title link-nav" href="<?php echo e(route('guest')); ?>">
                            <svg class="stroke-icon">
                    ...
                    <!-- Room Management -->
                    <li class="sidebar-list"><a
                            class="sidebar-link sidebar-title link-nav" href="<?php echo e(route('room')); ?>">
                            <svg class="stroke-icon">
                    ...
                    <!-- Booking Management -->
                    <li class="sidebar-list"><a
                            class="sidebar-link sidebar-title link-nav" href="<?php echo e(route('booking')); ?>">
                            <svg class="stroke-icon">
                    ...
                    <!-- Billing -->
                    <li class="sidebar-list"><a
                            class="sidebar-link sidebar-title link-nav" href="<?php echo e(route('billing')); ?>">
                            <svg class="stroke-icon">
                    ...
                    <li class="sidebar-list"><a
                            class="sidebar-link sidebar-title link-nav" href="<?php echo e(route('analytics')); ?>">
                            <svg class="stroke-icon">
...
<?php /**PATH C:\Users\clari\OneDrive\School\GitHub\Potatochips\booking_management\resources\views/Pokemon/Employee/Home/employee-sidebar.blade.php ENDPATH**/ ?>