   ...
   document.addEventListener('DOMContentLoaded', function () {
      ...
      signInButton.addEventListener('click', function (event) {
         ...
         if (role === 'receptionist') {
            ...
            if (email === 'receptionist@gmail.com' && password === 'receptionist123') {
...
<?php echo $__env->make('layouts.authentication.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Carl\OneDrive - Polytechnic University of the Philippines\Documents\WEB DEV AUTH\Potatochips\booking_management\resources\views/Pokemon/Employee/Authentication/login.blade.php ENDPATH**/ ?>