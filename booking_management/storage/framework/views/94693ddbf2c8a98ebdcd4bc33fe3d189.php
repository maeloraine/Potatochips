                                ...
                                <div class="card o-hidden">
                                    <div class="card-body"><span class="f-w-500 f-light">Total Bookings</span>
                                        <h4 class="mb-3 mt-1 f-w-500 mb-0 f-22"><span class="counter">102
                                            ...
                                            class="purchase-btn btn btn-primary btn-hover-effect f-w-500" href="<?php echo e(route('booking')); ?>">Book a Customer</a>
                                    </div>
                                </div>
                            </div>
                            <div class="col-6">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.simple.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\clari\OneDrive\School\GitHub\Potatochips\booking_management\resources\views/Pokemon/Employee/Home/employee-dashboard.blade.php ENDPATH**/ ?>